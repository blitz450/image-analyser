...
onFormChange = (event) => {
  ...
  onProfileUpdate = (data) => {
    fetch(`https://image-analyser-api.herokuapp.com/profile/${this.props.user.id}`, {
      method:'post',
      ...
      <div className='profile-modal'>
        <article className='br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center bg-white'>
          <main className='pa4 black-80 w-80'>
            ...
            <input onChange={this.onFormChange}  type='text' name='user-name' className='pa2 ba w-100' placeholder={user.name}></input>
